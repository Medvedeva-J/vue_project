...
export default {
    ...
    methods: {
        ...
        toggleFav() {
            this.$emit('toggleFav', this.product.id)
        },

        toggleCart() {
            this.$emit('toggleCart', this.product.id)
        }
    },
